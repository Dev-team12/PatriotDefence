...
public class ReportDocumentBuilder {
     ...
     */
    ReportDocumentBuilder addImage(Image img, float xPosition, float yPosition) throws DocumentException {
     ...
     * @return doc with few line skipped.
     */
    ReportDocumentBuilder addNewLine(int countLine) throws DocumentException {
        while (countLine != 0) {
     ...
     * @return ReportDocumentBuilder.
     */
    ReportDocumentBuilder addLineSeparator(LineSeparator ls) throws DocumentException {
     ...
     * @return ReportDocumentBuilder.
     */
    ReportDocumentBuilder addTable(PdfPTable table) throws DocumentException {
        document.add(table);
        return this;
    }
     ...
     * @return ReportDocumentBuilder.
     */
    ReportDocumentBuilder addParagraph(Paragraph paragraph, int alignment) throws DocumentException {
