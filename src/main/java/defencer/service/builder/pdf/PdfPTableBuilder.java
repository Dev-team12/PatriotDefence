...
public class PdfPTableBuilder {
    ...
    PdfPTableBuilder(int columns, float widthPercentage, int spacing) {
     ...
     */
    private PdfPTableBuilder addPdfPCell(String title, BaseColor bgColor, Font font) {
     ...
     * @return this builder instance
     */
    PdfPTableBuilder addPdfPCells(BaseColor bgColor, Font font, String... titles) {
